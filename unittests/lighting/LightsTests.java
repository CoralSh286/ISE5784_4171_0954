...
public class LightsTests {
    ...
    public void sphereDirectional() {
        ...
        scene1._lights.add(new DirectionalLight(sphereLightColor, sphereLightDirection));
    ...
    public void trianglesDirectional() {
        ...
        scene2._lights.add(new DirectionalLight(trianglesLightColor, trianglesLightDirection));
...
//    }
    ...
    public void sphereMultipleLights() {
        scene1._geometries.add(sphere);
        scene1._lights.add(new DirectionalLight(new Color(100, 300, 200), new Vector(1, -1, -1)));
        scene1._lights.add(new PointLight(new Color(500, 300, 0), new Point(50, -50, 25))
                .setKl(0.001).setKq(0.0002));
        scene1._lights.add(new SpotLight(new Color(600, 400, 0), new Point(-50, -50, 25), new Vector(1, 1, -0.5))
                .setKl(0.001).setKq(0.0001));
