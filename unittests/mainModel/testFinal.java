...
//                        .setMaterial(new Material().setKd(0.3).setKs(0.2).setNShininess(9))
//                        .setEmission(new Color(240, 175, 170)),
//                new Plane(new Point(floorLength, 0, 0), new Vector(-1, 0, 0))
//                        .setMaterial(new Material().setKd(0.3).setKs(0.2).setNShininess(9))
//                        .setEmission(new Color(170, 215, 250)),
//                new Plane(new Point(0, -floorHeight, 0), new Vector(0, 1, 0))
//                        .setMaterial(new Material().setKd(0.3).setKs(0.2).setNShininess(9)).setEmission(new Color(0.6,1,0.6)),
//                new Plane(new Point(0, 201, 0), new Vector(0, -1, 0))
//                        .setMaterial(new Material().setKd(0.3).setKs(0.2).setNShininess(9)).setEmission(new Color(150)),
...
//
//                // CubeMan body
//                new Prism(-75, 0, -25, 50, 50, 50).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(90)),
//                new Prism(-70, 50, -20, 40, 40, 40).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(110)),
//                new Prism(-65, 90, -15, 30, 30, 30).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(130)),
//
//                // CubeMan arms
//                new Prism(-30, 70, -7, 24, 14, 14, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(70)),
//                new Prism(-70, 70, -7, 14, 24, 14, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(70)),
//
//                new Prism(-19, 83, -6, 20, 12, 12, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(95)),
//                new Prism(-81, 81, -6, 12, 20, 12, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(95)),
//
//                new Prism(-10, 93, -5, 12.5, 10, 10, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(115)),
//                new Prism(-89, 90, -5, 10, 15, 10, true)
//                        .setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7)).setEmission(new Color(115)),
//
//                // CubeMan eyes
//                new Prism(-58, 110, 15, 3, 3, 3).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(3)),
//                new Prism(-45, 110, 15, 3, 3, 3).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(3)),
//
//                // CubeMan smile
//                new Prism(-60, 96, 15, 20, 3, 3).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(3)),
//                new Prism(-60, 99, 15, 3, 3.5, 3).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(3)),
//                new Prism(-43, 99, 15, 3, 3.5, 3).setMaterial(new Material().setKd(0.7).setKs(0.6).setNShininess(7))
//                        .setEmission(new Color(3)),
//
//                // SphereMan body
//                new Sphere(28d, new Point(50, 28, 0))
//                        .setMaterial(new Material().setKd(0.2).setKt(0.45).setKs(0.5).setNShininess(10))
...
//                        .setEmission(smileColor));
//
//        _geometries floor = new _geometries();
...
//            .setVPDistance(100)
//            .setVpSize(150, 150)
//            .setImageWriter(new ImageWriter("snow", 450, 450))
//            .setMultithreading(3)
//            .setDebugPrint(0.1);
//
//
