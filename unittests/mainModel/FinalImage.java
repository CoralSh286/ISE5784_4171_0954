...
//                new Sphere(new Point(-0, 200, 0), 100).setEmission(new Color(0, 50, 100)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)
//                                .setkT(new Double3(0.5, 0, 0))),
//                new Sphere(new Point(-900, 200, 0), 100).setEmission(new Color(100, 50, 20)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)),
//                new Sphere(new Point(-0, 1200, 0), 100).setEmission(new Color(0, 50, 100)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)
//                                .setkT(new Double3(0.5, 0, 0))),
//                new Sphere(new Point(-900, 1200, 0), 100).setEmission(new Color(100, 50, 20)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)),
...
//                        .setMaterial(new Material().setKd(1).setKs(0d).setNShininess(60)),
...
//                        .setMaterial(new Material().setKd(1).setKs(0.1).setNShininess(20)),
...
//                        .setMaterial(new Material().setKd(1).setKs(0.1).setNShininess(40)),
...
//                        .setMaterial(new Material().setKd(1).setKs(0.1).setNShininess(60)),
//                new Polygon(new Point(-900, 1000, 600),new Point(-900, 1000, 400),
//                        new Point(-900, 700, 400),new Point(-900, 700, 600)).setEmission(new Color(67,239,252))
//                        .setMaterial(new Material().setKd(0.5).setKs(0.1).setNShininess(20).setkT(0.5).setkR(0.25)),
//                new Sphere(new Point(-700, 800, 500), 70).setEmission(new Color(172,91,10))
...
//
//                //////////////////////////////////////////////////////////////////////
//                new Sphere(new Point(-0, -3300, 0), 100).setEmission(new Color(0, 50, 100)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)
//                                .setkT(new Double3(0.5, 0, 0))),
//                new Sphere(new Point(-900, -3300, 0), 100).setEmission(new Color(100, 50, 20)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)),
//                new Sphere(new Point(-0, -2300, 0), 100).setEmission(new Color(0, 50, 100)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)
//                                .setkT(new Double3(0.5, 0, 0))),
//                new Sphere(new Point(-900, -2300, 0), 100).setEmission(new Color(100, 50, 20)) //
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20)),
...
//                        .setMaterial(new Material().setKd(0.5).setKs(0.1).setNShininess(20).setkT(0.5).setkR(0.25)),
//                new Sphere(new Point(-700, -2700, 500), 70).setEmission(new Color(172,91,10))
//                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setNShininess(50)),
...
//                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setNShininess(20).setkR(0.1)),
...
//                        .setMaterial(new Material().setKd(0).setKs(1d).setNShininess(20).setkR(0.1)),
...
//                        .setMaterial(new Material().setKd(0).setKs(0d).setNShininess(20).setkT(1).setkB(5)));
//        scene._lights.add(new SpotLight(new Color(1000, 25, 25),new Point(-925,2000,1000),
//                new Vector(9.25,-25,-10)).setKl(4E-5).setKq(2E-7));
//        scene._lights.add(new DirectionalLight(new Color(4, 160, 0), new Vector(-9.25,25,10)));
//        scene._lights.add( new PointLight(new Color(255, 20, 20), new Point(0, 0, 1000)) //
//                .setKl(0.000004).setKq(0.000000006));
//        scene._lights.add(new SpotLight(new Color(100, 255, 25),new Point(-0,2000,1000),
//                new Vector(15,-20,-10)).setKl(4E-5).setKq(2E-7));
//        scene._lights.add( new PointLight(new Color(255, 100, 20), new Point(-1000, 500, 300)) //
//                .setKl(4E-5).setKq(2E-7));
//        scene._lights.add( new PointLight(new Color(255, 100, 20), new Point(-1000, -3000, 300)) //
//                .setKl(4E-5).setKq(2E-7));
//
