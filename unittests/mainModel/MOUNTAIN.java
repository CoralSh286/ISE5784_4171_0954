...
//                snowM = new Material().setKd(0.3).setKs(0.6).setNShininess(200),
//                seaM = new Material().setKd(0.2).setKs(0.9).setNShininess(3000),
...
//        //------------Light source------------
//
//        scene._lights.add(new DirectionalLight(new Color(200,200,0), new Vector(0,0,-1)));
//        scene._lights.add(new SpotLight(new Color(123,104,238),new Point(10,-30,40), new Vector(-1, 3,7)));
//
//        // Sun
//        scene._lights.add(new PointLight(new Color(YELLOW),new Point(-100, 140, 100)).setKc(1));
//
//        //-------------End light source--------------------
//
//
...
//                .setLocation(new Point(1000, -3000, 1000))
//                .setVPDistance(500)
//                .setVpSize(150, 150)
//                .setImageWriter(new ImageWriter("TheMountainsNoImp", 800, 800))
//                .setMultithreading(3)
//                .setDebugPrint(0.1);
//
//        cameraBuilder.build()
